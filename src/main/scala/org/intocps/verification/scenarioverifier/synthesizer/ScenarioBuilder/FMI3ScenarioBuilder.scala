...
import org.intocps.verification.scenarioverifier.core.FMI3.{ClockType, FMI3ScenarioModel, Fmu3Model, InputClockModel, InputPortModel, OutputClockModel, OutputPortModel}
import org.intocps.verification.scenarioverifier.core.{ConnectionModel, PortRef, ScenarioModel}
