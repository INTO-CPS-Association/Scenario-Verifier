...
import org.intocps.verification.scenarioverifier.core.{LoopConfigInit, NoLoopInit, RootStepStatement}
...
case class RootEventStatement(get: String = "",
                              set: String = "",
                              setClock: String = "",
                              getClock: String = "",
                              step: String = "",
                              next: String = "") extends EventStatement {
  require(get.nonEmpty || set.nonEmpty | step.nonEmpty | next.nonEmpty, "At least one of get or set must be defined")
}


case class FMI3RootInitStatement(get: String = "",
                                 set: String = "",
                                 getInterval: String = "",
                                 getShift: String = "",
...
case class EventStrategyStatement(clocks: List[String] = Nil,
                                  iterate: List[RootEventStatement]
                                 )
