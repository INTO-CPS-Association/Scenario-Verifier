...
import core.{ConnectionModel, ConnectionParserSingleton, EnterInitMode, ExitInitMode, InitializationInstruction, NestedInitStatement, NestedStepStatement, NoLoopInit, PortRef, Reactivity, RootStepStatement, ScenarioLoader}
import io.circe._
...
object ScenarioLoaderFMI3 extends Logging {
  ...
  private def parsePortRef(str: String, context: String, fmus: Map[String, Fmu3Model]): PortRef = {
    val pRes = core.FMURefParserSingleton.parse(core.FMURefParserSingleton.fmu_port_ref, str)
